/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings src/worker-configuration.d.ts` (hash: cdd90d39d7aeef84009323dfdb80dd28)
// Runtime types generated with workerd@1.20260911.1 2026-08-15 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	...
	VAULT: DurableObjectNamespace<import("./index").VaultDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "VaultDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_ORIGIN" | "DEFAULT_SIGNUP_MODE">> {}
}
